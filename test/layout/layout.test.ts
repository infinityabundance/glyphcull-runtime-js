...
describe('LayoutEngine', () => {
  ...
  it('sizes table columns from the natural width of the cell text (per-run)', async () => {
    ...
    const chunks = chnkPayload([
      ...
      {
        id: 2, kind: ChunkKind.Table, flags: 1 << 4, parentId: 1,
        firstChildId: 3, lastChildId: 4, depth: 1,
      },
      {
        id: 3, kind: ChunkKind.TableRow, flags: 1 << 4, parentId: 2, nextId: 4,
        firstChildId: 5, lastChildId: 6, depth: 2,
      },
      {
        id: 4, kind: ChunkKind.TableRow, flags: 1 << 4, parentId: 2, prevId: 3,
        firstChildId: 7, lastChildId: 8, depth: 2,
      },
      {
        id: 5, kind: ChunkKind.TableCell, parentId: 3, nextId: 6,
        firstChildId: 9, lastChildId: 9, depth: 3,
      },
      {
        id: 6, kind: ChunkKind.TableCell, parentId: 3, prevId: 5,
        firstChildId: 10, lastChildId: 10, depth: 3,
      },
      {
        id: 7, kind: ChunkKind.TableCell, parentId: 4, nextId: 8,
        firstChildId: 11, lastChildId: 11, depth: 3,
      },
      {
        id: 8, kind: ChunkKind.TableCell, parentId: 4, prevId: 7,
        firstChildId: 12, lastChildId: 12, depth: 3,
      },
      {
        id: 9, kind: ChunkKind.Paragraph, parentId: 5,
        firstChildId: 13, lastChildId: 13, depth: 4,
      },
      {
        id: 10, kind: ChunkKind.Paragraph, parentId: 6,
        firstChildId: 14, lastChildId: 14, depth: 4,
      },
      {
        id: 11, kind: ChunkKind.Paragraph, parentId: 7,
        firstChildId: 15, lastChildId: 15, depth: 4,
      },
      {
        id: 12, kind: ChunkKind.Paragraph, parentId: 8,
        firstChildId: 16, lastChildId: 16, depth: 4,
      },
    ...
    expect(table!.w).toBeCloseTo(columns.reduce((a, b) => a + b, 0), 3);
