...
Status: Phase 3 complete — threat model defined (Phase 0); the security posture
of the runtime (typed errors, bounded readers, no global state) is covered by the
